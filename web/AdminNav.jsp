	...
	<header class="main-header">
		...
		<ul>
                    ...
                    <li>
                        ...
                        <span class="fa fa-cart-arrow-down" aria-hidden="true"></span> Manage Item </a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <span class="fa fa-pencil-square-o" aria-hidden="true"></span> Payment Status </a>
                    </li>
                    <li>
                        <a href="AssignRiderController?action=listRider">
                        <span class="fa fa-motorcycle" aria-hidden="true"></span> Assign Rider </a>
                    </li>
                    <li>
                        <a  href="Report.jsp">
                        <span class="fa fa-clipboard" aria-hidden="true"></span> Report </a>
                    </li>
                    <li>

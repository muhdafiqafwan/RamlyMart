...
<html lang="zxx">
	...
	<!--//tags -->
	<link href="css/bootstrap.css" rel="stylesheet" type="text/css" media="all"<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html lang="zxx">
                    ...
                    <div class="wrapper">
                        ...
                        <div class="product-sec2">
                            <center>
                                ...
                                <br>
                                <form name="form1" method="post" id="ff" action="PaymentController?action=filterItem">
                                    <select name="filter" class="filter-Fill">
                                        <option>All</option>
                                        <option>COD</option>
